...
function QuizScreen() {
  ...
  const [startTimerOnExamStart, setStartTimerOnExamStart] = useState(false);
  ...
  if (showInstructions) {
    return (
      <div className="instruction_container" style={{ marginTop: "20px" }}>
  ...
  return (
    <>
      ...
      <Grid spacing={6} container justifyContent={"center"} alignItems="center" height={"70vh"}>
        ...
        >
          ...
          >
            ...
            {submitted ? (
              ...
              <MKBox p={3}>
                <MKTypography variant="body1" style={{ fontSize: "20px" }} color="text"  >
